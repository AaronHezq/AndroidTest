	...
	private void playVideo(Integer Media) {
		...
		try {
			...
			case LOCAL_VIDEO:
				 ...
				 */
				path = "http://shbcwl-m.qiniudn.com/tqyNH6kFDSN21GTyaiE1l3sQPTc=/lhCzZQTFSWkmRpfGKjwS_k87FRVN";
				if (path == "") {
					// Tell the user to provide a media file URL.
					Toast.makeText(
							MediaPlayerDemo_Video.this,
							"Please edit MediaPlayerDemo_Video Activity, " + "and set the path variable to your media file path."
			...
			case STREAM_VIDEO:
				...
				if (path == "") {
					...
					Toast.makeText(MediaPlayerDemo_Video.this,
							"Please edit MediaPlayerDemo_Video Activity," + " and set the path variable to your media file URL.",
...
//			path = "http://gslb.tv.sohu.com/live?cid=2&type=hls";
			path = "http://shbcwl-m.qiniudn.com/tqyNH6kFDSN21GTyaiE1l3sQPTc=/lhCzZQTFSWkmRpfGKjwS_k87FRVN";
