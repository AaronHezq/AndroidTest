package com.example.androidtest.residemenu;
...
public class ResideMenu extends FrameLayout {
	...
	private void initViews(Context context) {
		...
		backgroundLayout = (RelativeLayout) findViewById(R.id.iv_layout);
		imageViewShadow = (ImageView) findViewById(R.id.iv_shadow);
		imageViewBackground = (ImageView) findViewById(R.id.iv_background);
		userName = (TextView) findViewById(R.id.meun_username);
	}
...
//		parent.removeView(relativeLayout);
	...
	public void openMenu(int direction) {
		...
		AnimatorSet scaleDown_shadow = buildScaleDownAnimation(imageViewShadow, mScaleValue + shadowAdjustScaleX, mScaleValue
				+ shadowAdjustScaleY);
		AnimatorSet alpha_menu = buildMenuAnimation(backgroundLayout, 1.0f);
	...
	public void closeMenu() {
		...
		AnimatorSet alpha_menu = buildMenuAnimation(backgroundLayout, 0.0f);
	...
	private Animator.AnimatorListener animationListener = new Animator.AnimatorListener() {
		...
		public void onAnimationStart(Animator animation) {
			if (isOpened()) {
				showLayoutViewMenu(backgroundLayout);
		...
		public void onAnimationEnd(Animator animation) {
			...
			if (isOpened()) {
				...
				hideLayoutMenu(backgroundLayout);
				if (menuListener != null)
...
//		//修改Animator
//		alphaAnimation.playTogether(ObjectAnimator.ofFloat(target, "scaleX", alpha));
//		alphaAnimation.playTogether(ObjectAnimator.ofFloat(target, "scaleY", alpha));
	...
	public boolean dispatchTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (pressedState == PRESSED_DOWN) {
				...
				ViewHelper.setAlpha(backgroundLayout, (1 - targetScale) * 2.0f);
				
//				//修改Animator
//				ViewHelper.setScaleX(backgroundLayout, (1 - targetScale) * 2.0f);
//				ViewHelper.setScaleY(backgroundLayout, (1 - targetScale) * 2.0f);
	...
	private void showLayoutViewMenu(RelativeLayout relativeLayout) {
		if (relativeLayout != null && relativeLayout.getParent() == null) {
			addView(relativeLayout);
		}
	}

	private void hideLayoutMenu(RelativeLayout relativeLayout) {
		if (relativeLayout != null && relativeLayout.getParent() != null) {
