package refresh.rentals.lib;

import java.security.InvalidParameterException;

import refresh.rentals.lib.refresh_view.BaseRefreshView;
import refresh.rentals.lib.refresh_view.SunRefreshView;
import refresh.rentals.lib.util.Utils;
...
public class PullToRefreshView extends ViewGroup {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		widthMeasureSpec = MeasureSpec.makeMeasureSpec(getMeasuredWidth() - getPaddingRight() - getPaddingLeft(),
				MeasureSpec.EXACTLY);
		heightMeasureSpec = MeasureSpec.makeMeasureSpec(getMeasuredHeight() - getPaddingTop() - getPaddingBottom(),
				MeasureSpec.EXACTLY);
