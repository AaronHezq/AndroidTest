package refresh.rentals.lib.refresh_view;


import refresh.rentals.lib.PullToRefreshView;
...
@SuppressLint("NewApi") public abstract class BaseRefreshView extends Drawable implements Drawable.Callback, Animatable {
